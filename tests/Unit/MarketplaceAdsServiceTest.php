...
{
    public function test_profile_ads_hide_standard_square_but_keep_large_square(): void
    {
        ...
        $placements = (new MarketplaceAdsService)->splitProfileAds(collect([
            $square,
            $horizontal,
            $fullPage,
            $largeSquare,
    ...
    public function test_profile_ad_split_supports_legacy_full_size_key_without_a_loaded_relation(): void
    {
        $legacyFullSize = new UserAd(['size_type' => 'full-size']);

        $placements = (new MarketplaceAdsService)->splitProfileAds(collect([$legacyFullSize]));
