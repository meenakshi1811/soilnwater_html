...
use App\Http\Controllers\Institute\InstituteJobController;
...
Route::prefix('school')->name('school.')->middleware(['school.account'])->group(function (): void {
    ...
    Route::get('/jobs', [InstituteJobController::class, 'index'])->middleware('school')->name('jobs.index');
    Route::post('/jobs', [InstituteJobController::class, 'store'])->middleware('school')->name('jobs.store');
    Route::put('/jobs/{job}', [InstituteJobController::class, 'update'])->middleware('school')->name('jobs.update');
    Route::delete('/jobs/{job}', [InstituteJobController::class, 'destroy'])->middleware('school')->name('jobs.destroy');
    Route::patch('/jobs/applications/{application}', [InstituteJobController::class, 'updateApplication'])->middleware('school')->name('jobs.applications.update');
...
Route::prefix('institute')->name('institute.')->middleware(['institute.account'])->group(function (): void {
    ...
    Route::get('/jobs', [InstituteJobController::class, 'index'])->middleware('institute')->name('jobs.index');
    Route::post('/jobs', [InstituteJobController::class, 'store'])->middleware('institute')->name('jobs.store');
    Route::put('/jobs/{job}', [InstituteJobController::class, 'update'])->middleware('institute')->name('jobs.update');
    Route::delete('/jobs/{job}', [InstituteJobController::class, 'destroy'])->middleware('institute')->name('jobs.destroy');
    Route::patch('/jobs/applications/{application}', [InstituteJobController::class, 'updateApplication'])->middleware('institute')->name('jobs.applications.update');
