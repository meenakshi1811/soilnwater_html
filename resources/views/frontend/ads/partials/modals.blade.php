                    ...
                    <div class="offer-share-panel mt-4" id="adSharePanel">
                        ...
                        <div class="offer-share-panel-body">
                            ...
                            <div class="offer-share-links-wrap">
                                ...
                                <p class="small text-muted mt-2 mb-0" id="adShareHint">On Android, pick <strong>Instagram</strong> from the share list for Story or DM. The link is copied automatically.</p>
                            </div>
                        </div>
                    </div>
