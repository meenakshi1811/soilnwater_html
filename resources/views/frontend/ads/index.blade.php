...
@section('content')
<section class="mb-4">
  <img src="https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?auto=format&fit=crop&w=2200&q=80" alt="Ads market banner" class="w-100" style="display:block;max-height:220px;object-fit:cover;">
</section>
