...
@if ($ad->final_image)<img src="{{ asset($ad->final_image) }}" alt="{{ $ad->title }}" class="card-img-top" style="width:100%; max-height:560px; object-fit:cover;">@endif
...
@if($ad->subcategory)<p class="mb-2"><strong>Subcategory:</strong> {{ $ad->subcategory->name }}</p>@endif
