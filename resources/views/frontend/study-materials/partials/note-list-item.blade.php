...
<article class="sm-note-card">
    ...
    <div class="sm-note-card__main">
        <div class="sm-note-card__head">
            <div>
            ...
            <time class="sm-note-card__date" datetime="{{ $item->created_at?->toDateString() }}">{{ $item->created_at?->format('M d, Y') }}</time>
        </div>
        ...
        <div class="sm-note-card__footer">
            <div class="sm-note-card__author">
                <a href="{{ $item->educator?->publicUrl() ?: '#' }}" class="sm-note-card__avatar-link">
                ...
                <div>
                    ...
                    <div class="sm-note-card__stats">
                        <span><i class="fa-solid fa-star"></i> {{ number_format((float) $item->average_rating, 1) }} ({{ number_format($item->reviews_count) }})</span>
            ...
            <div class="sm-note-card__actions">
                @auth
                    ...
                    >
                        <i class="fa-{{ !empty($item->is_bookmarked) ? 'solid' : 'regular' }} fa-bookmark"></i>
                        Save
                    </button>
                @else
