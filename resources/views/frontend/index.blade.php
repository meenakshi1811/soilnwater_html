  ...
  <div class="main-col">
    ...
    <div class="sec recent-ads-section">
      ...
      <div class="ad-slider auto-ad-slider recent-ads-slider" data-show-arrows="true" data-show-dots="false" aria-label="Recent approved ads slider">
        ...
        @empty
          <div class="ad-slide">
            <div class="recent-ads-grid recent-ads-grid--empty">
              <article class="card h-100 shadow-sm border-0 offer-coupon-card recent-ad-card">
                <div class="offer-coupon-image-wrap">
...
<style>
  ...
  .recent-ads-grid--empty {
    grid-template-columns: minmax(0, 1fr);
  }
  @media (max-width: 1399.98px) {
    .recent-ads-grid { grid-template-columns: repeat(4, minmax(0, 1fr)); }
  }
  @media (max-width: 991.98px) {
    .recent-ads-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); }
  }
  @media (max-width: 575.98px) {
    .recent-ads-grid { grid-template-columns: minmax(0, 1fr); }
  }
