...
<div class="vendors-page vendors-page--categories">
  @include('frontend.marketplace.partials.breadcrumb', ['module' => 'consultants', 'current' => 'Categories'])
    ...
    <main class="vendors-main">
      <section class="vendors-hero vendors-hero--compact">
        <div class="vendors-hero__intro">
          ...
          <p>Browse every consultant category on SoilnWater and jump straight to experts in the area you need.</p>
        </div>
