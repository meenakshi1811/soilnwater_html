...
@endif
    ...
    @endif
        ...
        <div class="consultant-services-heading mb-4">
            <div>
                <p class="consultant-services-heading__eyebrow mb-1">Services</p>
                <h2 class="vendor-section-title-display mb-0">Available services</h2>
            </div>
            @if($showViewAllServicesButton ?? true)
                <a href="{{ route('service_provider.public-services.index', $service_provider->slug) }}" class="consultant-services-heading__btn">View all services</a>
            @endif
        </div>
        @endif
                ...
                <div class="{{ $serviceColumnClass }}">
                    <article class="consultant-service-card h-100">
                        ...
                        <div class="consultant-service-card__body">
                            <p class="consultant-service-card__category">{{ $service->categoryModel?->name ?? $service->category ?? 'Service' }}</p>
                            <h3>{{ $service->name }}</h3>
                            ...
                            @else
                                <button type="button" class="consultant-service-card__btn" data-bs-toggle="modal" data-bs-target="#service_providerLoginRequiredModal">View details</button>
                            @endauth
                        </div>
                    </article>
                </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-xl">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div>
                                        <p class="consultant-service-detail-modal__eyebrow mb-1">{{ $service->categoryModel?->name ?? $service->category ?? 'Service' }}</p>
                                        <h3 class="modal-title" id="{{ $modalId }}Label">{{ $service->name }}</h3>
                                    </div>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <div class="consultant-service-detail-modal__media consultant-service-detail-modal__media--centered">
                                        @if($image)
