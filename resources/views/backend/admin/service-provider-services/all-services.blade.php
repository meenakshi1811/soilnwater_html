...
<div class="admin-panel ems-page">
  <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2"><div><p class="ems-kicker mb-1">Admin Portal</p><h2 class="admin-title mb-0">All Services</h2></div><a href="{{ route('admin.service-provider-services.index') }}" class="btn btn-outline-primary">Pending Approvals</a></div>
