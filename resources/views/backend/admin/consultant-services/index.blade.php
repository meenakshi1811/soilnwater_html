...
<div class="admin-panel ems-page">
  ...
  <div class="chart-card p-3 p-lg-4"><div class="table-responsive"><table id="consultantServicesApprovalTable" class="table table-hover align-middle w-100"><thead><tr><th>Service</th><th>Consultant</th><th>Category</th><th>Price</th><th>Status</th><th>Submitted</th><th class="text-end">Actions</th></tr></thead></table></div></div>
</div>
@endsection
@push('scripts')
