...
<div class="admin-panel ems-page">
  <div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('admin.consultant-services.index') }}" class="btn btn-outline-secondary">Back</a>
  </div>
  <div class="chart-card p-4">
    ...
    <dl class="row">
      ...
      <dd class="col-sm-9">{{ $service->consultant?->display_name ?: $service->consultant?->company_name ?: '-' }}</dd>
      ...
      <dt class="col-sm-3">Consultant Location</dt>
