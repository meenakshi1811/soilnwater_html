                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="pan_number" id="vendorPan" class="form-control" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label d-block">Do you have a GST number?</label>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input js-vendor-has-gst" type="radio" name="has_gst" id="vendorHasGstNo" value="0" checked>
                                <label class="form-check-label" for="vendorHasGstNo">No</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input js-vendor-has-gst" type="radio" name="has_gst" id="vendorHasGstYes" value="1">
                                <label class="form-check-label" for="vendorHasGstYes">Yes</label>
                            </div>
                        </div>
                        <div class="col-md-6 d-none" id="vendorGstWrap">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="government_certificate_number" id="vendorGovernmentCertificate" class="form-control">
                        </div>
                    </div>
                </div>
