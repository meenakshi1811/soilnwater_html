...
<div class="admin-panel ems-page">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        ...
        <a href="{{ route('vendor.branches.create') }}" class="btn btn-primary ems-btn-primary">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="chart-card h-100">
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('vendor.branches.edit', $branch) }}" class="btn btn-sm btn-outline-primary">Manage</a>
...
document.querySelectorAll('.js-delete-branch').forEach(function(btn) {
    btn.addEventListener('click', function() {
        ...
        fetch('/vendor/branches/' + btn.dataset.id, {
            method: 'DELETE',
