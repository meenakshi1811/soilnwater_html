        ...
        <div class="col-12 col-lg-5">
            <div class="chart-card">
                ...
                <div class="mb-2">
                    ...
                    <strong>{{ !empty($selectedCategoryLabels) ? implode(', ', $selectedCategoryLabels) : '-' }}</strong>
                </div>
                <div class="mb-2">
                    <span class="text-secondary">Sub Category:</span>
                    <strong>{{ !empty($selectedSubcategoryLabels) ? implode(', ', $selectedSubcategoryLabels) : '-' }}</strong>
                </div>
                <div class="mb-2">
