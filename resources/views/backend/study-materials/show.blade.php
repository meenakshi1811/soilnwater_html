        ...
        <div class="chart-card mb-4">
          <div class="d-flex justify-content-between align-items-start gap-2 flex-wrap mb-3">
            ...
            @if($material->solvedWorksheetFileUrl())
              <a href="{{ route('admin.study-materials.solved-worksheet-download', $material) }}" class="btn btn-sm btn-outline-primary">
        ...
        <div class="chart-card mb-4">
          <div class="d-flex justify-content-between align-items-start gap-2 flex-wrap mb-3">
            ...
            @if($material->solutionFileUrl())
              <a href="{{ route('admin.study-materials.solution-download', $material) }}" class="btn btn-sm btn-outline-primary">
