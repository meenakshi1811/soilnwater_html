...
<div class="admin-panel ems-page service_provider-branch-form">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('service_provider.branches.index') }}" class="btn btn-light">Back to list</a>
    </div>

    <form id="service_provider-branch-form" method="POST" action="{{ $branch->exists ? route('service_provider.branches.update', $branch) : route('service_provider.branches.store') }}" enctype="multipart/form-data">
        @csrf
        @if($branch->exists) @method('PUT') @endif

        <div class="service_provider-form-card mb-4">
            <h5 class="service_provider-form-card-title"><span>1</span> Basic Details</h5>
            <div class="row g-3">
                <div class="col-md-6">
        ...
        <div class="service_provider-form-card mb-4">
            <h5 class="service_provider-form-card-title"><span>2</span> Contact &amp; Location</h5>
            <div class="row g-3">
                <div class="col-md-4">
        ...
        <div class="service_provider-form-card mb-4">
            <h5 class="service_provider-form-card-title"><span>3</span> Legal &amp; Info</h5>
            <div class="row g-3">
                <div class="col-md-6">
...
$(function () {
    const $form = $('#service_provider-branch-form');
    ...
    $form.on('submit', function (e) {
        ...
        $.ajax({
            ...
            success: function (resp) {
                ...
                setTimeout(() => window.location.href = resp.redirect || '{{ route('service_provider.branches.index') }}', 900);
            },
            error: function (xhr) {
