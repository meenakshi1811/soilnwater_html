...
<style>
  #service_providerServicesTable {
    min-width: 1120px;
  }

  #service_providerServicesTable th,
  #service_providerServicesTable td {
    vertical-align: middle;
  }

  #service_providerServicesTable .service-provider-services-actions {
    min-width: 220px;
    white-space: nowrap;
  }

  #service_providerServicesTable .service-provider-services-actions__group {
    display: inline-flex;
    align-items: center;
        ...
        <tbody>
          @foreach($services as $service)
            <tr>
              ...
              <td class="text-end service-provider-services-actions">
                <div class="service-provider-services-actions__group">
                  <a href="{{ route('service_provider.services.show', $service) }}" class="btn btn-sm btn-outline-secondary">View</a>
                  <a href="{{ route('service_provider.services.edit', $service) }}" class="btn btn-sm btn-outline-primary">Edit</a>
...
<script>
var service_providerServicesDataTable = null;
if (window.jQuery && document.getElementById('service_providerServicesTable')) {
  service_providerServicesDataTable = window.jQuery('#service_providerServicesTable').DataTable({
    pageLength: 10,
    order: [],
    scrollX: true,
    autoWidth: false,
