...
<script>
if (window.jQuery && document.getElementById('service_providerInquiriesTable')) {
  window.jQuery('#service_providerInquiriesTable').DataTable({
    pageLength: 10,
    lengthMenu: [[10, 25, 50, 100, -1], [10, 25, 50, 100, 'All']],
    order: [[0, 'desc']],
    language: { emptyTable: 'No service inquiries yet.' }
  });
}
</script>
@endpush
