...
<div class="admin-panel ems-page service_provider-dashboard-redesign">
    ...
    <div class="row g-4">
        ...
        <div class="col-md-4">
            <a href="{{ route('service_provider.branches.index') }}" class="action-card d-block text-decoration-none h-100">
...
@push('styles')
<style>
.service_provider-dashboard-redesign .service_provider-hero {
...
.service_provider-dashboard-redesign .service_provider-kicker {
    color: #e9d5ff;
    font-weight: 600;
    letter-spacing: .08em;
...
.service_provider-dashboard-redesign .service_provider-hero-btn { border-radius: 999px; font-weight: 600; }
.service_provider-dashboard-redesign .stat-card,
.service_provider-dashboard-redesign .action-card {
    border-radius: 16px;
    padding: 1.1rem;
    border: 0;
...
.service_provider-dashboard-redesign .stat-card:hover {
    transform: translateY(-4px);
    box-shadow: 0 12px 24px rgba(15, 23, 42, .18);
}
.service_provider-dashboard-redesign .stat-detail {
    display: block;
    font-size: .72rem;
    line-height: 1.35;
}
.service_provider-dashboard-redesign .stat-purple { background: linear-gradient(135deg, #9333ea, #7e22ce); }
.service_provider-dashboard-redesign .stat-blue { background: linear-gradient(135deg, #2563eb, #1d4ed8); }
.service_provider-dashboard-redesign .stat-cyan { background: linear-gradient(135deg, #06b6d4, #0e7490); }
.service_provider-dashboard-redesign .stat-orange { background: linear-gradient(135deg, #f97316, #ea580c); }
.service_provider-dashboard-redesign .action-card {
    background: #fff;
    color: #1f2937;
    transition: transform .2s ease, box-shadow .2s ease;
}
.service_provider-dashboard-redesign .action-card:hover {
    transform: translateY(-4px);
    box-shadow: 0 12px 24px rgba(15, 23, 42, .15);
}
.service_provider-dashboard-redesign .icon-wrap {
    width: 48px;
    height: 48px;
    border-radius: 14px;
    display: inline-flex;
...
.service_provider-dashboard-redesign .bg-purple { background: linear-gradient(135deg, #a855f7, #7e22ce); }
.service_provider-dashboard-redesign .bg-green { background: linear-gradient(135deg, #22c55e, #15803d); }
.service_provider-dashboard-redesign .bg-amber { background: linear-gradient(135deg, #f59e0b, #d97706); }
.service_provider-dashboard-redesign .vendor-store-code {
    background: #eff6ff;
    color: #1e3a8a;
...
@media (max-width: 767px) {
    .service_provider-dashboard-redesign .service_provider-hero { flex-direction: column; align-items: flex-start; }
}
</style>
@endpush
