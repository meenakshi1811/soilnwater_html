@php
    ...
    $skipKeys = array_merge(
        ...
        [
            ...
            'competitions_declaration_original',
            'competitions_declaration_permission',
            'competitions_declaration_ai_disclosed',
            'competitions_declaration_rules',
            'competitions_declaration_display',
        ]
    );
...
@if($post->isCompetitionsPost() && $additionalMeta->isNotEmpty())
    @if($railLayout)
