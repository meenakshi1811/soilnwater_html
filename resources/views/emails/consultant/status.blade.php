...
@section('content')
    ...
    @if ($isRejected && ! empty($consultantDetails['reason']))
        <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin: 0 0 16px;">
            <tr>
                <td style="padding: 16px; background-color: #fffbeb; border: 1px solid #fde68a; border-radius: 10px;">
                    ...
                    <p style="margin: 0; font-size: 14px; color: #78350f; line-height: 1.7; white-space: pre-wrap;">{{ $consultantDetails['reason'] }}</p>
                </td>
            </tr>
        </table>
    @endif
