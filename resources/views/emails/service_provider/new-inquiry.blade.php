<!doctype html>
<html>
<head><meta charset="utf-8"><title>New service enquiry</title></head>
<body style="font-family: Arial, sans-serif; color:#0f2b4d; line-height:1.6;">
    <h2 style="margin-bottom:8px;">New service enquiry</h2>
    <p>You have received a new enquiry for <strong>{{ $service?->name ?? 'a matching service_provider service' }}</strong>.</p>
    ...
    <p style="margin-top:18px;">Please log in to your service provider portal to view and respond to this enquiry.</p>
</body>
</html>
