...
@php
    ...
    $serviceName = $service?->name ?? 'a matching services listing';
@endphp

<h2 style="margin:0 0 10px;font-size:28px;color:#0f172a;">New Services Enquiry</h2>
...
<p style="margin:18px 0 0;color:#475569;font-size:14px;">Please log in to your Services portal to view and respond to this enquiry.</p>
@endsection
