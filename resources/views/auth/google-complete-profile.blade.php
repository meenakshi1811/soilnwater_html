                    ...
                    <form id="googleCompleteForm" method="POST" action="{{ route('register.google.complete.store') }}" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <select id="role" class="form-select @error('role') is-invalid @enderror" name="role" required>
                                ...
                                <option value="teacher" {{ $role === 'teacher' ? 'selected' : '' }}>Teacher / Tutor</option>
                            </select>
                            @error('role')
                                <span class="invalid-feedback d-block" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        ...
                        <div id="profileImageWrap" class="mb-3 {{ in_array($role, ['user', 'vendor', 'consultant', 'service_provider', 'teacher'], true) ? '' : 'd-none' }}">
