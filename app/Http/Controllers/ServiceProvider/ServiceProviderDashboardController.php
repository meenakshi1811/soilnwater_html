        ...
        return view('backend.service_provider.dashboard', [
            ...
            'stats' => [
                [
                    ...
                    'detail' => 'Manage every active service provider location',
                ...
                [
                    ...
                    'detail' => 'Slides shown on your public service provider page',
                ...
                [
                    ...
                    'detail' => 'Custom content blocks on your service provider profile',
                    'url' => route('service_provider.public-page.edit'),
                    'class' => 'stat-orange',
                ],
            ],
