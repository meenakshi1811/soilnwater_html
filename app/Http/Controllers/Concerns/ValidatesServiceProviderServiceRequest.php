...
trait ValidatesServiceProviderServiceRequest
{
    protected function serviceProviderCategories()
    {
    ...
    protected function validatedServiceProviderService(Request $request, ?ServiceProviderService $service = null): array
    {
    ...
    protected function uniqueServiceProviderServiceSlug(int $serviceProviderId, string $name, ?int $exceptId = null): string
    {
