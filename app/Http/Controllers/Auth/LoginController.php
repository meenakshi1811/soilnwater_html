...
class LoginController extends Controller
{
    ...
    public function googleCallback(Request $request): RedirectResponse
    {
        ...
        $createdViaGoogleRegister = false;
        ...
        if (! $user) {
            ...
            $createdViaGoogleRegister = $intent === 'register';
        }

        if ($createdViaGoogleRegister) {
            return redirect()
                ->route('login')
                ->with('status', 'Registration successful. Your account details have been saved. Please login to continue.');
        }
