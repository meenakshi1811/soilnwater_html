        ...
        return DataTables::of($query)
            ...
            ->addColumn('actions', function (Vendor $vendor): string {
                ...
                return '<div class="d-flex gap-2 justify-content-end">'
                    ...
                    .'<a href="'.route('admin.vendors.public-page.edit', $vendor).'" class="btn btn-sm btn-outline-info" title="Edit store page"><i class="fa-solid fa-store"></i></a>'
    ...
    public function edit(Vendor $vendor): JsonResponse
    {
        ...
        return response()->json([
            'vendor' => [
                ...
                'has_gst' => $vendor->gst_number ? '1' : '0',
                'gst_number' => $vendor->gst_number,
                'government_certificate_number' => $vendor->government_certificate_number,
