...
class PostOfferController extends Controller
{
    ...
    {
        return $user->isAdmin() || $user->isGeneralUser() || $user->isVendor() || $user->isConsultant() || $user->canModule('vendors', 'read');
    }

    private function canCreate($user): bool
    {
        return $user->isAdmin() || $user->isGeneralUser() || $user->isVendor() || $user->isConsultant() || $user->canModule('vendors', 'add');
    }

    private function canWrite($user): bool
    {
        return $user->isAdmin() || $user->isGeneralUser() || $user->isVendor() || $user->isConsultant() || $user->canModule('vendors', 'write');
    }

    private function canDelete($user): bool
    {
        return $user->isAdmin() || $user->isGeneralUser() || $user->isVendor() || $user->isConsultant() || $user->canModule('vendors', 'delete');
    }
